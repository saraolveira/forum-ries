    ...
    return (
        <>
            ...
            <EdicionHeroSinIMG 
                ...
                links={<>
                    <a href='https://forumries.com/blog/docs/RIES2016_memoria.pdf' target='_blank'>{t('links.report')} #RIES16</a>
                    <a href='https://forumries.com/blog/galeria-ediciones-anteriores/#ries2016' target='_blank'>{t('links.gallery')}</a>
                </>}  
            />
            <Icono />
            <Footer />
