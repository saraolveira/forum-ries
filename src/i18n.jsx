                    ...
                    pages: {
                        ...
                        ponentes: {
                            ...
                            description: {
                                ...
                                manuelBosch:
                                    "Manuel Bosch se incorporó a Ribera en el año 2000 y actualmente es Director de Innovación y Transformación Digital donde lidera proyectos innovadores relacionados con la transformación digital y la gestión de la salud de la población y coordina la estrategia de calidad basada en los estándares de atención de la Joint Commission Internation (JCI). Es licenciado en Comunicación Empresarial por la Universidad Cardenal Herrera CEU (Valencia), Máster en Administración de la Salud por el IESE Business School (Madrid) y Máster en Gestión Financiera por la Escuela de Negocios Lluís Vives, y está realizando la tesis doctoral sobre la aplicación de herramientas de economía de la salud para correlacionar la evolución de la morbilidad y los sistemas de pago. Es profesor en diversos cursos y seminarios, relacionados con modelos de control de gestión, planificación estratégica y gestión de empresas, y ha coordinado varias publicaciones de gestión sanitaria.",
                    ...
                    pages: {
                        ...
                        ponentes: {
                            ...
                            description: {
                                ...
                                manuelBosch:
                                    "Manuel Bosch joined Ribera in 2000 and is currently Director of Innovation and Digital Transformation where he leads innovative projects related to digital transformation and population health management and coordinates the quality strategy based on healthcare standards. the Joint Commission International (JCI). He has a degree in Business Communication from the Cardenal Herrera CEU University (Valencia), a Master in Health Administration from the IESE Business School (Madrid) and a Master in Financial Management from the Lluís Vives Business School, and is completing his doctoral thesis on application of health economics tools to correlate the evolution of morbidity and payment systems. He is a professor in various courses and seminars related to management control models, strategic planning and business management, and has coordinated several health management publications.",
