    ...
    return (
        <div id="hero23">
            <div id="datos">
                ...
                <div id="tematicas">
                    <p className="tema" onClick={handleLongevidad}>
                        {t("hero23.longevity")}
                    </p>
                    <span className="border"></span>
                    <p className="tema" onClick={handleBiotech}>
                        Biotech
                    </p>
                    <span className="border"></span>
                    <p className="tema" onClick={handleOnehealth}>
                        Onehealth
                    </p>
                    <span className="border"></span>
                    <p className="tema" onClick={handleIA}>
                        {t("hero23.ia")}
                    </p>
                </div>
            </div>
            ...
            <div id="circulos">
                <div id="circulos-wrap">
                    <div
                        ...
                        className={
                            fondo === "inicio"
                                ? "circulo circulos hidden show"
                                : "circulo circulos hidden hide"
                        }
                    >
                        <Circulos />
                    ...
                    <img
                        id="circulo-longevidad"
                        className={
                            fondo === "Longevidad"
                                ? "circulo circulos hidden show"
                                : "circulo circulos hidden hide"
                        }
                        src="circulo-longevidad.png"
                    />
                    <img
                        id="circulo-biotech"
                        className={
                        ...
                        src="circulo-biotech.png"
                    />
                    <img
                        id="circulo-onehealth"
                        className={
                            fondo === "Onehealth"
                                ? "circulo circulos hidden show"
                                : "circulo circulos hidden hide"
                        }
                        src="circulo-onehealth.png"
                    />
                    <img
                        id="circulo-ia"
                        className={
            ...
            <div id="colab">
                ...
                <div id="colaboradores">
                    ...
                    <div id="colab-logos">
                        ...
                        <img
                            src="/colab/echalliance.png"
                            alt="logo ECHAlliance"
                        />
                        <img
                            src="/colab/cc-coruna.png"
                            alt="logo Camara de Comercio de A Coruña"
                        />
                        <img
                            src="/colab/cse.png"
